...
class JInstallationModelDatabase extends JModelLegacy
{
	...
	/* Improve the performance of slit queries function provided by Joomla */
	function _splitQueries ($sql, $delimiter = ';') 
	{ 
		 // trip all comment start with #
