    ...
    <div id="megamenu-toolbox">
      ...
      <div id="megamenu-toolsub" class="toolbox">
        <ul>
          ...
          <li><a href="" class="btn toolsub-addrow toolbox-action" data-action="addRow">Add Row</a></li>
          <li>Width (px): <input type="text" class="toolsub-width toolbox-input" name="toolsub-width" data-name="width" value="" /></li>
          <li>Extra Class: <input type="text" class="toolsub-exclass toolbox-input" name="toolsub-exclass" data-name="class" value="" /></li>
        </ul>
      </div>
      <div id="megamenu-toolcol" class="toolbox">
        <ul>
          <li><a href="" class="btn toolcol-addcol toolbox-action" data-action="addColumn">Add Column</a></li>
          <li><a href="" class="btn toolcol-removecol toolbox-action" data-action="removeColumn">Remove Column</a></li>
          <li>Width (1-12): <input type="text" class="toolcol-width toolbox-input" name="toolcol-width" data-name="width" value="" /></li>
          <li>Module: 
          ...
          <li>Extra Class: <input type="text" class="toolcol-exclass toolbox-input" name="toolcol-exclass" data-name="class" value="" /></li>
        </ul>
      </div>    
    </div> 
    
      <div class="toolbox-actions-group">
        <button class="btn btn-success toolbox-action toolbox-saveConfig" data-action="saveConfig">Save</button>
